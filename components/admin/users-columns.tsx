    ...
    },
    {
      ...
      cell: ({ row }) => {
        ...
        if (!tags || tags.length === 0) {
          return <span className="text-muted-foreground">{t('noTags')}</span>;
        }
        return (
        ...
        return (
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuSeparator />
              <DropdownMenuItem>{tActions('viewDetails')}</DropdownMenuItem>
              <DropdownMenuItem>{tActions('editUser')}</DropdownMenuItem>
              <DropdownMenuSeparator />
