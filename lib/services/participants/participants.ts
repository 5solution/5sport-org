...
export type participantControllerAssignPartnerResponseSuccess =
  participantControllerAssignPartnerResponse200 & {
    headers: Headers;
  };
export type participantControllerAssignPartnerResponse =
  participantControllerAssignPartnerResponseSuccess;

export const getParticipantControllerAssignPartnerUrl = (
  eventId: unknown,
  id: string,
) => {
...
export const participantControllerAssignPartner = async (
  eventId: unknown,
  id: string,
  participantControllerAssignPartnerBody: ParticipantControllerAssignPartnerBody,
  options?: RequestInit,
): Promise<participantControllerAssignPartnerResponse> => {
  return defaultMutator<participantControllerAssignPartnerResponse>(
    getParticipantControllerAssignPartnerUrl(eventId, id),
    {
      ...options,
      method: "PATCH",
      headers: { "Content-Type": "application/json", ...options?.headers },
      body: JSON.stringify(participantControllerAssignPartnerBody),
    },
  );
};

export const getParticipantControllerAssignPartnerMutationOptions = <
  TError = unknown,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    {
      eventId: unknown;
      id: string;
      data: ParticipantControllerAssignPartnerBody;
    },
    TContext
  >;
  request?: SecondParameter<typeof defaultMutator>;
...
> => {
  ...
  > = (props) => {
    ...
    return participantControllerAssignPartner(
      eventId,
      id,
      data,
      requestOptions,
...
export type ParticipantControllerAssignPartnerMutationResult = NonNullable<
  Awaited<ReturnType<typeof participantControllerAssignPartner>>
>;
export type ParticipantControllerAssignPartnerMutationBody =
  ParticipantControllerAssignPartnerBody;
 ...
 * @summary Assign partner for a doubles participant
 */
export const useParticipantControllerAssignPartner = <
  TError = unknown,
  TContext = unknown,
>(
  options?: {
...
> => {
  return useMutation(
    getParticipantControllerAssignPartnerMutationOptions(options),
    queryClient,
  );
};
/**
...
export type participantControllerRemovePartnerResponseSuccess =
  participantControllerRemovePartnerResponse200 & {
    headers: Headers;
  };
export type participantControllerRemovePartnerResponse =
  participantControllerRemovePartnerResponseSuccess;

export const getParticipantControllerRemovePartnerUrl = (
  eventId: unknown,
  id: string,
) => {
  return `/events/${eventId}/participants/${id}/partner`;
...
export const participantControllerRemovePartner = async (
  eventId: unknown,
  id: string,
  options?: RequestInit,
): Promise<participantControllerRemovePartnerResponse> => {
  return defaultMutator<participantControllerRemovePartnerResponse>(
    getParticipantControllerRemovePartnerUrl(eventId, id),
    {
      ...options,
      method: "DELETE",
    },
...
export const getParticipantControllerRemovePartnerMutationOptions = <
  TError = unknown,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type ParticipantControllerRemovePartnerMutationResult = NonNullable<
  Awaited<ReturnType<typeof participantControllerRemovePartner>>
>;
 ...
 * @summary Remove partner from a doubles participant
 */
export const useParticipantControllerRemovePartner = <
  TError = unknown,
  TContext = unknown,
>(
  options?: {
...
> => {
  return useMutation(
    getParticipantControllerRemovePartnerMutationOptions(options),
    queryClient,
  );
};
/**
